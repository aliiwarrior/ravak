<template>
  <div class="services alternate">
    ...
    <div class="allServices">
      <div id="service1" class="service service1">
        <div class="text text1">
          ...
          <router-link to="/service">learn more</router-link>
        </div>
      </div>
    ...
    <div id="service3" class="goToService3"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    serviceAnime() {
      ...
      tl.to(".allServices", { top: "-100vh" });
      tl.to(".text2", { paddingTop: "0px", duration: 1 });
      tl.to(".allServices", { top: "-200vh" });
